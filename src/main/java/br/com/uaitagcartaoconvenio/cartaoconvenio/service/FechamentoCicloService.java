...
public class FechamentoCicloService {
	...
	public String fechamentoCiclo( String anoMes, Boolean execManual )  {
	    ...
	    if (anoMes     == null) { throw new IllegalArgumentException("O parâmetro anoMes não pode ser nulo");     }	    
	    if (execManual == null) { throw new IllegalArgumentException("O parâmetro execManual não pode ser nulo"); }
	    ...
	    if (existeFechamento == null || !existeFechamento) { return "NÃO EXISTE CICLO PARA SER PROCESSADO PARA O PERÍODO: " + anoMes; }
