...
--
-- TOC entry 3430 (class 2606 OID 24418)
-- Name: funcionario fk_funcionario_limite_credito; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.funcionario
    ADD CONSTRAINT fk_funcionario_limite_credito FOREIGN KEY (id_limite_credito) REFERENCES public.limite_credito(id_limite_credito);
...
--
-- TOC entry 3432 (class 2606 OID 24428)
-- Name: funcionario fk_funcionario_salario; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.funcionario
    ADD CONSTRAINT fk_funcionario_salario FOREIGN KEY (id_salario) REFERENCES public.salario(id_salario);
